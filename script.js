8
        ...
        function myBtn(){
            location.reload();
            alert("IT'S VERY SIMPLE JUST KEEP YOUR MIND CALM 👍")
        }
       ...
       window.console = window.console || function(t) {};
        ...
        var cards = ['c', 'cpp', 'java', 'html', 'css', 'js', 'react', 'python'];
    ...
    $('.flip-container').click(function(){
        ...
        if (!outOfTime) {
            ...
            if (!gameStarted && !running){//before the game starts, show all cards to the user and flip back
                ...
                if (chosenCards[0] == chosenCards[1]) {
                    ...
                    if (pairCount == cards.length) {
                        win = true;
                        alert("CONGRATES 🎉, YOU WON 🤩 YOUR MEMORY IS SO FAST 👌❤️");
                    }
            ...
            alert("OOPESS! 😢,YOU HAVE RUN OUT OF TIME 😔 \n RESTART THE GAME .");
        };
